...
default_data = [
    ...
    {"users": []},
    {"users": []},
    {"Version": "1.0.0", "server_id": 713475017957965945, "delete_msg_days": 7, "mute_amount": 2, "prefix": "^", "logging_channel": 1264171411296227370, "logging_on": False, "blacklist_on": False, "chatbot_on": False, "bot_max_tokens": 150, "last_bans": [], "bot_read_msg": 10}
]
